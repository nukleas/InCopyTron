...
InCopyTron.Plugins.CENsorSuite = {
    ...
    push_error_to_listbox: function(errorObject) {
        this.output_to_listbox(
            [errorObject],
            InCopyTron.GUI.Window.findElement("error_listbox")
        );
    },
    generateGUI: function(mainGUI) {
        var error_checking_box = mainGUI.parent.findElement("error_listbox"),
            //Refresh button Start
            refresh_button = error_checking_box.parent.add(
                "button",
                undefined,
                "Refresh"
            );
        refresh_button.onClick = function() {
            ...
            InCopyTron.Plugins.CENsorSuite.output_to_listbox(
                InCopyTron.Plugins.CENsorSuite.run_tests(),
                error_checking_box
            );
        };
        //Refresh Button Stop
